...
public class HashLinearProbingTest {
    ...
    HashLinearProbing<String> hashOfInitalSizeTenWithFiveHundredElems;
    ArrayList<String> words = new WordsFromFileArray("words.txt");

    @Before
    public void setUp() {
        emptyHashOfSizeTen = new HashLinearProbing<>(10);
        hashOfSizeTenWithSevenElems = new HashLinearProbing<>(10);
    ...
    public void should_ThrowException_WhenInitialSizeIsLowerThanOne() {
        ...
        // when
        HashTable<Double> hashSizeZero = new HashLinearProbing<>(initialSize);
    ...
    public void should_CorrectlyDeleteElemAndBeAbleToGetRemainingElems_WhenDeletingElemThatIsInHash() {
        ...
        for (int index = 0; index < numOfElemsInHash; index++) {
            ...
            hashOfInitalSizeTenWithFiveHundredElems = new HashLinearProbing<>(10);
